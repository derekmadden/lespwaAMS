		...
		$sidebarHTML .= '<!-- Sidebar -->
			    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
			      ...
			      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index">
			        ...
			        <!-- div class="sidebar-brand-text mx-3">AMS Admin <sup>2</sup></div -->
			        <div class="sidebar-brand-text mx-3">Lespwa AMS</sup></div>
			      </a>
			      ...
			      <!-- Nav Item - Maintenance Requests Collapse Menu -->
			      <li class="nav-item">
		      	...
		      	<footer class="sticky-footer bg-white">
		        	<div class="container my-auto">
			          <div class="copyright text-center my-auto">
			            <span>Copyright &copy; Lespwa.co 2021</span>
			          </div>
			        </div>
			    </footer>
		    	<!-- End of Footer -->';
			      	...
			      	<div class="modal-content">
				        ...
				        <div class="modal-body">Select "Logout" below if you are ready to end your current session.</div>
			        		<div class="modal-footer">
				          		...
				          		<a class="btn btn-primary" href="#" onclick="logoutUser()">Logout</a>
				        	</div>
				      	</div>
				    </div>
				</div>';
