...
testAjax(function(output){
  ...
  for (i = 0; i < words.length; i++) {
    ...
    const newWordsTemp = newWords[0].split(',');
  ...
  // var chartLabels = new Array();
  // var obj = JSON.parse(output, function (key, value) {
  //   if (key == "year") {

  //     // alert(value);

  //     if(chartLabels.indexOf(value) !== -1){
  //         // alert("Value exists, skipping!")
  //     } else{
  //         // alert("Value does not exist, adding!")
